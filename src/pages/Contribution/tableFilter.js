...
import {
  appAllGetContribution,
  appDeleteContribution,
  appUpdateContribution,
} from "../../store/contribution";
...
const [error , setError] = useState("");
  ...
  useEffect(() => {
    ...
    dispatch(appAllGetContribution(searchParams));
     ...
     {error && <span className="text-danger">{error}</span>}
          ...
          <div className="table-responsive bootgrid">
            <table className="table table-hover" id="bootgrid-command">
              ...
              {contribution?.data &&
                contribution?.data.map((value, index) => {
                  return (
                    <tbody key={index}>
                      <tr>
                        <td>
                        ...
                        <td>
                          {value.status === "Pending" && (
                            <div style={{ display: "flex", gap: "5px" }}>
                              <button
                                ...
                                onClick={() =>
                                  handleAcceptedContribution(value?._id)
                                }
                              >
                              ...
                              <button
                                ...
                                onClick={() =>
                                  handleRejectedContribution(value?._id)
                                }
                              >
                          ...
                          {value.status === "Rejected" && (
                            <button
                              ...
                              className="btn btn-sm btn-danger command-delete"
                              onClick={() =>
                                handleDeleteContribution(value?._id)
                              }
                            >
